...
```{r}
# function for elimintaint participants who gave the same answer on every trial
...
if (file.exists("../results/pa_outcomes_dist_adults_drop_subjects.RDS")) {
  
  pa_outcomes_dist_adults <- readRDS("../results/pa_outcomes_dist_adults_drop_subjects.RDS")
  ...
  saveRDS(pa_outcomes_dist_adults, file = "../results/pa_outcomes_dist_adults_drop_subjects.RDS")
}
...
factor_names_adults <- data.frame(factor = c(colnames(efa_us_adults$loadings),
  ...
  mutate(factor_descript = recode(factor,
                                  ...
                                  vtADULTS_F2 = "Harmony (mind-like, heart-like)",
                                  vtADULTS_F1 = "Sin (body-like)"),
...
if (file.exists("../results/cong_df_adults_drop_subjects.RDS")) {
  
  cong_df_adults <- readRDS("../results/cong_df_adults_drop_subjects.RDS")
  ...
  saveRDS(cong_df_adults, file = "../results/cong_df_adults_drop_subjects.RDS")
}
```
...
cong_plot_fun(cong_df = cong_df_adults, which_country = "US") +
  ...
  # ylim(NA, 1) +
  labs(x = NULL)
ggsave("../figures/fig03_drop_subjects.png")
```
...
cong_plot_fun(cong_df = cong_df_adults %>%
              ...
              which_country = "Ghana") +
  ylim(min_cong_adults$min_cong, 1)
ggsave("../figures/figS01_drop_subjects.png")
```
...
cong_plot_fun(cong_df = cong_df_adults, 
  ...
  ylim(min_cong_adults$min_cong, 1)
ggsave("../figures/figS02_drop_subjects.png")
```
...
cong_plot_fun(cong_df = cong_df_adults, 
              which_country = "China") +
  ylim(min_cong_adults$min_cong, 1)
ggsave("../figures/figS03_drop_subjects.png")
```
...
cong_plot_fun(cong_df = cong_df_adults %>%
  ...
  ylim(min_cong_adults$min_cong, 1)
ggsave("../figures/figS04_drop_subjects.png")
```
...
if (file.exists("../results/pa_outcomes_dist_children_drop_subjects.RDS")) {
  
  pa_outcomes_dist_children <- readRDS("../results/pa_outcomes_dist_children_drop_subjects.RDS")
  ...
  saveRDS(pa_outcomes_dist_children, file = "../results/pa_outcomes_dist_children_drop_subjects.RDS")
}
...
if (file.exists("../results/cong_df_children_drop_subjects.RDS")) {
  
  cong_df_children <- readRDS("../results/cong_df_children_drop_subjects.RDS")
  ...
  saveRDS(cong_df_children, file = "../results/cong_df_children_drop_subjects.RDS")
}
```
...
ggsave("../figures/fig04_drop_subjects.png")
```
...
cong_all_ordered %>%
  ...
  geom_text(aes(label = format(round(cong, 2), nsmall = 2),
            ...
            show.legend = F) +
  # mind-like factors
  annotate("rect", xmin = 0.5, xmax = 10.5, ymin = 20.5, ymax = 30.5,
           color = cong_plot_colors[1], size = 1.5, alpha = 0) +
  # body-like factors
  annotate("rect", xmin = 13.5, xmax = 23.5, ymin = 7.5, ymax = 17.5,
           color = cong_plot_colors[3], size = 1.5, alpha = 0) +
  # heart-like factors
  annotate("rect", xmin = 23.5, xmax = 30.5, ymin = 0.5, ymax = 7.5,
  ...
  labs(x = NULL, y = NULL, fill = expression(italic(r[c])))
ggsave("../figures/fig02_drop_subjects.png")
```
...
ggsave("../figures/figS05_drop_subjects.png")
...
plot_grid(heatmap_comp_fun(efa_list = list(efa_gh_adults, efa_gh_children), padding = F),
          ...
          ncol = 1, rel_heights = c(2, 1.5), labels = "AUTO")
ggsave("../figures/figS06_drop_subjects.png")
...
plot_grid(heatmap_comp_fun(efa_list = list(efa_th_adults, efa_th_children), padding = F),
          ...
          ncol = 1, rel_heights = c(2, 1.5), labels = "AUTO")
ggsave("../figures/figS07_drop_subjects.png")
...
plot_grid(heatmap_comp_fun(efa_list = list(efa_ch_adults, efa_ch_children), padding = F),
          ...
          ncol = 1, rel_heights = c(2, 1.5), labels = "AUTO")
ggsave("../figures/figS08_drop_subjects.png")
...
plot_grid(heatmap_comp_fun(efa_list = list(efa_vt_adults, efa_vt_children), padding = F),
          ...
          ncol = 1, rel_heights = c(2, 1.5), labels = "AUTO")
ggsave("../figures/figS09_drop_subjects.png")
```
...
ggsave("../figures/fig01_drop_subjects.png")
```
...
ggplot(rect_df %>%
  ...
  theme(panel.spacing.x = unit(c(rep(0.2, 4), 1, rep(0.25, 4)), "line"),
        ...
        legend.position = "bottom")
# ggsave("../figures/fig01v2_drop_subjects.png")
```
