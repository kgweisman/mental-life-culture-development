...
if (file.exists("../results/cong_df_adults_drop.RDS")) {
  
  cong_df_adults <- readRDS("../results/cong_df_adults_drop.RDS")
  ...
  saveRDS(cong_df_adults, file = "../results/cong_df_adults_drop.RDS")
}
```
...
cong_plot_fun(cong_df = cong_df_adults %>%
              ...
              which_country = "Ghana") +
  ylim(min_cong_adults$min_cong, 1)
ggsave("../figures/figS02_drop.png")
```
...
cong_plot_fun(cong_df = cong_df_adults, 
  ...
  ylim(min_cong_adults$min_cong, 1)
ggsave("../figures/figS03_drop.png")
```
...
cong_plot_fun(cong_df = cong_df_adults, 
              which_country = "China") +
  ylim(min_cong_adults$min_cong, 1)
ggsave("../figures/figS04_drop.png")
```
...
cong_plot_fun(cong_df = cong_df_adults %>%
  ...
  ylim(min_cong_adults$min_cong, 1)
ggsave("../figures/figS05_drop.png")
```
...
if (file.exists("../results/cong_df_children_drop.RDS")) {
  
  cong_df_children <- readRDS("../results/cong_df_children_drop.RDS")
  ...
  saveRDS(cong_df_children, file = "../results/cong_df_children_drop.RDS")
}
```
...
ggsave("../figures/figS01_drop.png")
```
...
ggsave("../figures/fig01v1_drop.png")
```
...
ggplot(rect_df %>%
  ...
  theme(panel.spacing.x = unit(c(rep(0.2, 4), 1, rep(0.2, 4)), "line"),
        ...
        legend.position = "bottom")
# ggsave("../figures/fig01v2_drop.png")
```
...
loadings_adults %>%
  ...
  labs(x = NULL, y = NULL) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1),
        panel.spacing.x = unit(c(0.2, 1, 0.2, 1, 0.2, 1), "line"),
        legend.position = "bottom") +
  guides(fill = guide_colorbar(barwidth = 30, barheight = 0.5, 
                               title = "Factor loading", title.vjust = 1))
